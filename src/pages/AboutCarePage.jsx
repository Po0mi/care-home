            ...
            <div className="about-hero-stats" ref={heroStatsRef}>
              {STATS.map(({ value, label }, index) => (
                <div
                  ...
                  ref={(el) => (heroStatsItemsRef.current[index] = el)}
                >
                  <strong>{value}</strong>
                  <span>{label}</span>
                </div>
      ...
      <section className="about-content">
        <div className="about-content-inner">
          ...
          <div className="about-content-grid">
            <div className="about-story" ref={storyRef}>
              ...
              <p
                ...
                ref={(el) => (storyTextRef.current[0] = el)}
              >
              ...
              <p
                className="about-story-text"
                ref={(el) => (storyTextRef.current[1] = el)}
              >
          ...
          <div className="about-cta-strip" ref={ctaStripRef}>
            ...
            <Link to="/book-tour" className="about-cta-btn" ref={ctaBtnRef}>
              Book A Tour
              <svg
                viewBox="0 0 16 16"
                fill="none"
