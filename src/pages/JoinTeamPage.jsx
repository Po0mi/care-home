    ...
    <div className="join-team">
      ...
      <section className="join-team-hero" ref={heroRef}>
        ...
        <div className="join-team-hero-img" ref={heroImgRef}>
          <img src={TeamPhoto} alt="Sycamore Cottage team" />
        </div>
        ...
        <div className="join-team-hero-content">
            ...
            <div className="join-team-perks">
              {PERKS.map(({ icon, label }, index) => (
                <div
                  ...
                  ref={(el) => (perksRef.current[index] = el)}
                >
          ...
          <div className="join-team-card" ref={cardRef}>
            <div className="join-team-card-pill" ref={cardPillRef}>
              <span className="join-team-card-pill-dot" />
            ...
            <p className="join-team-card-body" ref={cardBodyRef}>
              We do not currently have any vacancies available, but please keep
              an eye on this page for any upcoming opportunities.
            </p>

            <p className="join-team-card-note" ref={cardNoteRef}>
              Interested in future roles? Get in touch and we'll keep your
              details on file.
            </p>
